...
for filename in os.listdir(directory_path):
    ...
    if filename.endswith(".csv") and filename.startswith("LEGe13725_Log_") and "_Cleaned" not in filename:
...
if cleaned_dataframes:
    ...
    combined_output_path = os.path.join(directory_path, "LEGe13725_Log_Combined_Cleaned.csv")
